...
#import "AXFVideoPlayerView.h"
#import "AXFVideoToolBar.h"
static const NSString *PlayerItemStatusContext;
static const NSString *PlayerItemLoadedTimeRangesContext;
@interface AXFVideoPlayerView  ()<AXFVideoToolBarDelegate>
@property (nonatomic,strong) AVPlayerLayer *playerLayer;
@property (nonatomic,strong) NSTimer *progressTimer;
@end

@implementation AXFVideoPlayerView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 底部工具条
        self.toolBarView = ({
            AXFVideoToolBar *toolBar = [[AXFVideoToolBar alloc] init];
...
#pragma mark - AXFVideoToolBarDelegate
/** <点击了底部工具条上的播放/暂停按钮> */

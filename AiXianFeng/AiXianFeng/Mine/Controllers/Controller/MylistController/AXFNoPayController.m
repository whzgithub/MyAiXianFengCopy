...
- (void)viewDidLoad {
    ...
    UIImageView* imgV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"v2_empty_pointsDeatil"]];
    ...
    UILabel* label = [UILabel cz_labelWithText:@"还没有付款哦~" fontSize:15 color:[UIColor grayColor]];
